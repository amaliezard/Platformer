...
enum AIType     { WALKER, JUMPER, FLYER, GUARD };
...
// Constructors
    ...
    Entity(GLuint texture_id, float speed, float width, float height, EntityType entityType); // Simplified constructor
